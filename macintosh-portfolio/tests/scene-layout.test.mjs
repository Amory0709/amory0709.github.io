...
import { sceneLayout, diskPlacement, boxCorners, sceneCameraFrames, cameraPose } from '../scene-layout.mjs';
...
for (const [width, height] of [[1222, 720], [366, 615], [296, 339], [794, 265], [722, 850], [1456, 640]]) {
  test(`perspective containment at ${width} × ${height}, overview and maximum zoom`, () => {
    ...
    assert.ok(cameraPose(frames, -.45).position.z > frames.overview.position.z);
